...
type: issue
state: closed
created: 2026-08-07T05:03:07Z
updated: 2026-08-07T09:28:30Z
author: vig-os-org-config[bot]
author_url: https://github.com/vig-os-org-config[bot]
url: https://github.com/vig-os/org-config/issues/99
comments: 1
...
parent: none
children: none
synced: 2026-08-08T03:28:21.623Z
---

# [Issue 99]: [Declared repository absent from org: part-registry](https://github.com/vig-os/org-config/issues/99)

<!-- drift-fingerprint: 3f543349d05d6796 -->
## Drift detected: `repository-inventory-missing:part-registry`
...
```text
Repository `part-registry` is declared in the committed Otterdog config but does not exist in the live `vig-os` organization.
