...
updated: 2026-08-07T09:28:32Z
author: vig-os-org-config[bot]
author_url: https://github.com/vig-os-org-config[bot]
url: https://github.com/vig-os/org-config/issues/100
comments: 1
...
parent: none
children: none
synced: 2026-08-08T03:28:21.263Z
---

# [Issue 100]: [Declared repository absent from org: meta](https://github.com/vig-os/org-config/issues/100)

<!-- drift-fingerprint: 80350684749314ee -->
## Drift detected: `repository-inventory-missing:meta`
...
```text
Repository `meta` is declared in the committed Otterdog config but does not exist in the live `vig-os` organization.
